...
def make_conf(resources, annotations, russian_pp, tqdm_conf, device='cpu', pretrained=False,
              n_epochs=50, padding=10, density=.2, version=0, module=Linear2BERT, split=.75,
...
def eval_config(resources, annotations, russian_pp, use_cuda, tqdm_conf, **kwargs):
    conf_args = [
        {'pretrained': True, 'version': 49, 'ontology_class': 'PrivacyPolicy'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'Data'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'PolicyChangeScope'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'DataBreachProcessing'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'FirstParty'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'DataBreach'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'DataActivity'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'DataActivityPurpose'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'LegalBasis'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'PolicyChange'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'PolicyAcceptanceTime'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'DataUse'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'DataProtection'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'SecurityMechanism'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'FPCollection'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'User'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'UserSpecificCommunicationMechanism'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'GeneralCommunicationMechanism'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'TPCollection'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'ThirdParty'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'TPSharing'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'DataRetention'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'DataRetentionTime'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'NotificationTime'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'FPNotification'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'UserNotification'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'AdvertisingDataControl'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'OptInOptOutControl'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'NonPersonalData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'PersonalData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'ServiceData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'FinancialData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'DeviceData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'ApplicationData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'AccountData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'TrackingData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'SensitiveData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'ReligionData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'RacialData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'GenericData'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'StoreOnEmployedServers'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'TechnicalSecurityMeasure'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'OrganizationalSecurityMeasure'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'PseudoAnonymization'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'Encryption'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'Firewall'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'AutomaticCommunicationMechanism'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'ViaServiceApp'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'ViaWebsite'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'WebsiteForm'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'DataProvision'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'PersonalVisit'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'Email'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'PostalMail'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'SMS'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'OnWebsitePage'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'InPrivacyPolicy'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'IntentionalBreach'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'UnintentionalBreach'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'PartialServiceRestriction'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'FullServiceRestriction'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'LegalCompliancePurpose'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'ServiceProvisionPurpose'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'ServiceEnhancementPurpose'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'AnalyticsPurpose'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'SecurityPurpose'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'ResearchPurpose'},
        {'pretrained': True, 'version': 49, 'ontology_class': 'MarketingPurpose'},
    ]
